...
public class SpringJavaConfiguration {
	...
	public DataSource dataSource() {
		...
		poolProperties.setUrl("jdbc:mysql://localhost:3306/smp_base?useUnicode=true&amp;characterEncoding=utf-8&amp;autoReconnect=true&amp;failOverReadOnly=false&amp;maxReconnects=10");
		poolProperties.setUsername("root");
		poolProperties.setPassword("qidi123");
	...
	public MapperScannerConfigurer getMapperScannerConfigurer(){
		...
		conf.setBasePackage("com.semp.api.mapping");
